...
function M:draw()
	...
	for i=-1, 1 do
		geo.line(tl.x, tl.y+i, tr.x, tr.y+i, 0xFFFF0000)
	end
	for i=-1, 1 do
		geo.line(tl.x+i, tl.y, dl.x+i, dl.y, 0xFFFF0000)
	end
	for i=-1, 1 do
		geo.line(dl.x, dl.y+i, dr.x, dr.y+i, 0xFFFF0000)
	end
	for i=-1, 1 do
		geo.line(tr.x+i, tr.y, dr.x+i, dr.y, 0xFFFF0000)
	end

	geo.box(0, 0, tl.x-1, dl.y-1, 0xaa444444)
	geo.box(tr.x+1, tr.y, fw.GameInfo.width - tr.x - 1, dl.y-1, 0xaa444444)
end
